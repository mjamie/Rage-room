...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        void SetTargetRotation()
        {
            ...
            localMovementDirection = Quaternion.Euler(0f, -20f, 0f) * localMovementDirection;  // Rotate slightly left
            
            Vector3 forward = Quaternion.Euler(0f, cameraSettings.Current.m_XAxis.Value ,0) * Vector3.forward;
            forward.y = 0f;
            forward.Normalize();
